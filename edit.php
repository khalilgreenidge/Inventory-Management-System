...
<html>
  <head>
    <meta charset="UTF-8">
    <title>HEDU IMS | Edit View</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
			...
			<form class="form" style="left: 0px" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
				...
				Value: <input type="text" name="value" onkeyup="upperCase()" required />	   
						<br/><br/>
